...
<body>
    ...
    <div class="main">
        ...
        <div class="right">
            <div class="id">
				<h2>영화 리뷰</h2> <a href="adminPage_tv_review.jsp"><h2>티비시리즈 리뷰</h2></a>
            </div>
              <table>
                  <tr>
					  <th>리뷰번호</th>
                  ...
                  <%
                      ...
                      Class.forName("org.mariadb.jdbc.Driver");
                       try (
                           Connection conn = DriverManager.getConnection(
                  			...
                  			ResultSet rs = stmt.executeQuery("select * from movie_review;");
                   ...
                   %>
                  <tr>
					<td><%=rs.getInt("m_review_num")%></td>
					<td><%=rs.getInt("m_review_star")%></td>
					<td><%=rs.getInt("member_num")%></td>
                    <td><%=rs.getString("m_review_content")%></td>
                    <td><%=rs.getString("m_review_time")%></td>
                    <td><%=rs.getString("m_review_content_id")%></td>
