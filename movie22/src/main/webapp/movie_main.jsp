...
request.setAttribute("msgList2", new JsonDAO().getMoviePasingData("","&with_genres=12"));
request.setAttribute("msgList3", new JsonDAO().getMoviePasingData("","&with_genres=16"));
request.setAttribute("msgList4", new JsonDAO().getMoviePasingData("","&with_genres=35"));
request.setAttribute("msgList5", new JsonDAO().getMoviePasingData("","&with_genres=80"));
request.setAttribute("msgList6", new JsonDAO().getMoviePasingData("","&with_genres=99"));
request.setAttribute("msgList7", new JsonDAO().getMoviePasingData("","&with_genres=18"));
request.setAttribute("msgList8", new JsonDAO().getMoviePasingData("","&with_genres=14"));
request.setAttribute("msgList9", new JsonDAO().getMoviePasingData("","&with_genres=36"));
request.setAttribute("msgList10", new JsonDAO().getMoviePasingData("","&with_genres=27"));
